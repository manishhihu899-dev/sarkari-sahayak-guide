      ...
      <main className="px-4 py-6 space-y-6">
        ...
        {searchQuery.length <= 1 && (
          <>
            ...
            <div className="relative rounded-3xl overflow-hidden opacity-0 animate-scale-up gradient-border">
              ...
              <div className="absolute inset-0 overflow-hidden">
                ...
                <div className="absolute right-1/3 top-4 opacity-15">
                  <BadgeCheck className="w-5 h-5 text-accent float-govt-icon" style={{ animationDelay: '1.5s' }} />
                </div>
              ...
              <div className="relative z-10 p-6 pt-8 pb-8">
                <div className="flex items-start gap-4">
                  ...
                  <div 
                    className="w-24 h-24 rounded-2xl flex items-center justify-center shrink-0 opacity-0 animate-scale-up overflow-hidden pulse-ring govt-seal-glow"
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex items-center gap-2 mb-2 opacity-0 animate-fade-up" style={{ animationDelay: '250ms', animationFillMode: 'forwards' }}>
                    ...
                    <h2 className="text-2xl font-bold text-white mb-2 leading-tight opacity-0 animate-fade-up" style={{ animationDelay: '300ms', animationFillMode: 'forwards' }}>
                      {t("🇮🇳 Swagat hai!", "🇮🇳 Welcome!")}
                    </h2>
                    <p className="text-sm text-white/90 leading-relaxed opacity-0 animate-fade-up" style={{ animationDelay: '350ms', animationFillMode: 'forwards' }}>
                      {t(
                ...
                <div className="flex items-center gap-4 mt-6 pt-4 border-t border-white/20 opacity-0 animate-slide-up" style={{ animationDelay: '450ms', animationFillMode: 'forwards' }}>
                  ...
                  <div className="flex-1 text-center group cursor-pointer hover:scale-105 transition-transform card-3d bg-white/5 rounded-xl p-2 backdrop-blur-sm">
                    <div className="flex items-center justify-center gap-1">
                      ...
                      <span className="text-xl font-bold text-white counter-animate" style={{ animationDelay: '0.1s' }}>100+</span>
                    </div>
                  ...
                  <div className="flex-1 text-center group cursor-pointer hover:scale-105 transition-transform card-3d bg-white/5 rounded-xl p-2 backdrop-blur-sm">
                    <div className="flex items-center justify-center gap-1">
                      ...
                      <span className="text-xl font-bold text-success neon-glow counter-animate" style={{ animationDelay: '0.2s' }}>FREE</span>
                    </div>
            ...
            <div className="grid grid-cols-3 gap-3 opacity-0 animate-fade-up" style={{ animationDelay: '550ms', animationFillMode: 'forwards' }}>
              <button 
                onClick={() => navigate('/schemes')}
                className="bg-gradient-to-br from-success/90 to-success p-4 rounded-2xl text-center shadow-card hover:shadow-elevated transition-all card-3d effect-shine"
              >
              ...
              <button 
                ...
                className="bg-gradient-to-br from-primary/90 to-primary p-4 rounded-2xl text-center shadow-card hover:shadow-elevated transition-all card-3d effect-shine"
              >
                <div className="w-10 h-10 bg-white/20 rounded-xl mx-auto mb-2 flex items-center justify-center">
              ...
              <button 
                ...
                className="bg-gradient-to-br from-accent/90 to-accent p-4 rounded-2xl text-center shadow-card hover:shadow-elevated transition-all card-3d effect-shine"
              >
                <div className="w-10 h-10 bg-white/20 rounded-xl mx-auto mb-2 flex items-center justify-center">
            ...
            <div className="flex items-center justify-center gap-3 py-3 opacity-0 animate-fade-up" style={{ animationDelay: '600ms', animationFillMode: 'forwards' }}>
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between px-1 opacity-0 animate-fade-up" style={{ animationDelay: '650ms', animationFillMode: 'forwards' }}>
